...
import cn.obanks.ar.model.Mail;
...
public class MailUtil {  
    ...
    public static void main(String[] args) {
         ...
         mail.setSender("z4812098@163.com");  
         mail.setPassword("a245175904"); // 发件人邮箱的登录密码 
         mail.setReceiver("2810261102@qq.com"); // 接收人  
         mail.setUsername("z4812098@163.com"); // 登录账号,一般都是和邮箱名一样吧  
