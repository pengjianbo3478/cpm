...
<link href="${static_ftiao_cn}/css/index.css?v=1.1" rel="stylesheet" type="text/css">
<link href="${static_ftiao_cn}/css/jquery.mCustomScrollbar.css?v=1.1" rel="stylesheet" type="text/css">
...
<script src="${static_ftiao_cn}/js/pop_up_w.js?v=1.1" charset="UTF-8"></script>
<script src="${static_ftiao_cn}/js/index/index.js?v=1.1" charset="UTF-8"></script>
<script src="${static_ftiao_cn}/js/jquery.mCustomScrollbar.concat.min.js?v=1.1" charset="UTF-8"></script>
