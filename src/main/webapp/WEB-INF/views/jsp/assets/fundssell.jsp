...
<%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="f"%>
	...
	<div id="fr_main" class="fr_main " >
	 ...
	 <table width="100%" border="0" >
	  ...
	  <!---页码----> 
	     <div  class="pagination"><a href="#">首页</a><a href="#">&lt;&lt;</a><span class="current">1</span><a href="#2">2</a><a href="#3">3</a><a href="#4">4</a><a href="#5">5</a><a href="#6">...</a><a href="#&gt;">&gt;&gt;</a><a href="#">尾页</a></div>
	      </div>     
	</div>
</body>
</html>
